      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 max-w-7xl">
        <div className="mb-10 text-center max-w-2xl mx-auto">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg">
            Browse through the courses offered in this subject and find the past
            papers you need.
          </p>
        </div>
              ...
              >
                ...
                <div className="relative z-10 flex-col flex h-full">
                  <div className="flex items-center justify-between mb-4">
                    <span className="px-3 py-1 bg-brand-100 dark:bg-brand-900/50 text-brand-700 dark:text-brand-300 text-xs font-bold rounded-full tracking-wide">
                      {course.code || "COURSE"}
                    </span>
                  </div>

                  <h2 className="text-xl font-bold text-slate-800 dark:text-white mb-3 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                    {course.name}
                  </h2>
                  ...
                  <div className="mt-auto pt-6">
                    <Link
                      ...
                      className="inline-flex w-full items-center justify-center px-4 py-2.5 bg-slate-50 dark:bg-slate-800 hover:bg-brand-600 dark:hover:bg-brand-500 text-slate-700 dark:text-slate-300 hover:text-white dark:hover:text-white text-sm font-semibold rounded-lg transition-all duration-200 border border-slate-200 dark:border-transparent hover:border-transparent focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-900 focus:ring-brand-600 outline-none"
                    >
                      View Past Papers
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
